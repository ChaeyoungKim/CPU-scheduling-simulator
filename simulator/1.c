...
int main(void) {
	...
	int n = (rand() % 10) + 1; //프로세스 개수는 1-10개
	...
	while (true) {
		printf("\n- - - - - - - - - - - - - - - - - - - - - -\n");
		printf("1. FCFS       2. Non-Preemptive SJF       3. Preemptive SJF       4. Non-Preemptive Priority\n5. Preemptive Priority       6. Round Robin       7. Evaluation(Only after you did 1~6, you can see the result.)\n8. Create new processes\n\n");
